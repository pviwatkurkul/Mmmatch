...
export default function Navbar() {
    return (
        <div className="bottom-1 left-1/2 sticky transform -translate-x-1/3 flex bg-white border border-customgreen gap-4 p-2.5 rounded-[20px] justify-between items-center w-60">
